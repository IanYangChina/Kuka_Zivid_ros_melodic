...
source = o3d.io.read_point_cloud(os.path.join(cwd, '..', 'objects', 'part_ref_grasp', 'pcd_reference_merged.ply'))
# source.transform(transform_cam_to_base_hand_calibrated)
# source.paint_uniform_color([1, 0, 0])

to_merge = o3d.io.read_point_cloud(os.path.join(cwd, '..', 'objects', 'pcl_part', 'pcd_reference_merged_registered.ply'))
...
o3d.io.write_point_cloud(os.path.join(cwd, '..', 'objects', 'part_ref_grasp', 'part_reference_merged.ply'), merged)
