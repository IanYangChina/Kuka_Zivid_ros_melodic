...
p1 = [-0.33955532155200313, -0.4919240673409368, 0.44322820096677445]
p1_q = [-0.09543869118016003, -0.34123433590221613, 0.8551217913627625, 0.3784405799265335]
...
p2 = [-0.6118599785082319, -0.2651555369743888, 0.4384940804041449]
p2_q = [0.06499232341504475, -0.15117182322076156, 0.9701617360115051, 0.17807115250318148]
...
p3 = [-0.6238490498687387, 0.06191429843213932, 0.6677410608636462]
p3_q = [0.019115162028591103, 0.013566951526794428, 0.9967168569564819, -0.07749866150190958]
...
pcd_3 = o3d.io.read_point_cloud(path_3)
...
p4 = [-0.6180526689359269, 0.3675919243464007, 0.30419067214329537]
p4_q = [0.04657256733135922, -0.053342850612119526, 0.8997739553451538, -0.43057209076882225]
...
pcd_4 = o3d.io.read_point_cloud(path_4)
...
p5 = [-0.2977190125241298, 0.4572420263707471, 0.2795479430701567]
p5_q = [-0.14926434756769433, 0.25636200667857995, 0.819904088973999, -0.4896488070420422]
...
pcd_5 = o3d.io.read_point_cloud(path_5)
...
p6 = [-0.10247700473305638, 0.4572632022505956, 0.31452236331668904]
p6_q = [0.10310314660490129, 0.8379407525062561, 0.2704636279176586, -0.4626818098029889]
...
pcd_6 = o3d.io.read_point_cloud(path_6)
...
p7 = [-0.31217047814232096, 0.29355731896807297, 0.5762597186817668]
p7_q = [0.09861816149797507, 0.9411432147026062, 0.27879016182263155, -0.16370694892710425]
...
pcd_7 = o3d.io.read_point_cloud(path_7)
