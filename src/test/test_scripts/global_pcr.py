...
target = o3d.io.read_point_cloud(os.path.join(cwd, '..', 'objects', 'part_ref_grasp', 'pcd_reference_crop.ply'))
...
source_original = o3d.io.read_point_cloud(os.path.join(cwd, '..', 'objects', 'pcl_part', 'part_reference_merged.ply'))
...
o3d.io.write_point_cloud(os.path.join(cwd, '..', 'objects', 'pcl_part', 'pcd_reference_merged_registered.ply'), source_after_icp_refinement)
