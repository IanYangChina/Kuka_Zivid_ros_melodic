...
# np.save(os.path.join(cwd, 'transformation_matrices', 'workspace_bounding_box_array_in_base'), workspace_bounding_box_array)
# exit()
...
pcd = o3d.io.read_point_cloud(os.path.join(cwd, '..', 'objects', 'part_ref_grasp', 'pcd_reference.ply'))
...
o3d.io.write_point_cloud(os.path.join(cwd, '..', 'objects', 'part_ref_grasp', 'pcd_reference_crop.ply'), cropped)
